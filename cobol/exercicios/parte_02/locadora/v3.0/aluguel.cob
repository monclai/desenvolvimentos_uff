      ...
      *-----------------------------------------------------------------
       ...
       fd file1 value of file-id is "registro_de_alugues.dat".
       01 file1-rec.
           02 fs-key.
               03 fs-cpf   pic 9(11) blank when zeros.
            02 fs-nome     pic x(40).
            02 fs-filme-1  pic x(40).
            02 fs-filme-2  pic x(40).
            02 fs-filme-3  pic x(40).
            02 filler      pic x(20).
      ...
      *         BLANK WHEN ZEROS.
           05 SS-DADOS.
               ...
               10 LINE 12 COLUMN 10 VALUE "FILME 1:".
               10 COLUMN PLUS 2 PIC X(40) USING fs-filme-1.
               10 LINE 13 COLUMN 10 VALUE "FILME 2:".
               10 COLUMN PLUS 2 PIC X(40) USING fs-filme-2.
               10 LINE 14 COLUMN 10 VALUE "FILME 3:".
               10 COLUMN PLUS 2 PIC X(40) USING fs-filme-3.
      ...
      * -----------------------------------
       ...
       INCLUI.
           ...
           IF COB-CRT-STATUS = COB-SCR-ESC
               GO INCLUI-FIM
           END-IF
           IF FS-NOME EQUAL SPACES OR fs-filme-1 EQUAL SPACES
               MOVE "FAVOR INFORMAR NOME E FILME 1" TO WS-MSGERRO
               PERFORM MOSTRA-ERRO
               GO INCLUI-LOOP
           END-IF
           WRITE FILE1-REC
           INVALID KEY
           MOVE "ALUGUEL JA REALIZADO" TO WS-MSGERRO
           PERFORM MOSTRA-ERRO
